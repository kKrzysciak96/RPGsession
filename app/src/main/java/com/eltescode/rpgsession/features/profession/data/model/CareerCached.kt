package com.eltescode.rpgsession.features.profession.data.model
...
data class CareerCached(
    val careerName: String,
    val mainProfile: MainProfileCached,
    val secondaryProfile: SecondaryProfileCached,
    ...
    constructor(career: CareerDomain) : this(
        ...
        mainProfile = MainProfileCached(career.mainProfile),
        secondaryProfile = SecondaryProfileCached(career.secondaryProfile),
...
data class SecondaryProfileCached(
    val a: Int,
    val zyw: Int,
    val s: Int,
    val wt: Int,
